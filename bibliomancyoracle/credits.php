...
<header class="waaw-header">
    ...
    <main>
        ...
        <p class="credits">
            Created by Lucila Mayol<br>
            Commissioned by WAAW Gallery<br>
            Design: Lucila Mayol<br>
            Web Implementation: Floriane Grosset<br>
            Algorithm: Sindre S&oslash;rensen<br>
            Produced with the support of: Kulturr&aring;det<br>
            2020
